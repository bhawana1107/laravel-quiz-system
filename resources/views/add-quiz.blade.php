    ...
    <div class=" flex flex-col items-center min-h-screen pt-5">
        <div class=" bg-white p-8 rounded-2xl shadow-lg w-full max-w-md">
            ...
            <form action="/add-quiz" method="get" class=" space-y-4">
                ...
                <div>
                    <input type="text" placeholder="Enter Quiz name" name= "quiz_name"
            ...
            <form action="" method="get" class="space-y-4">
               ...
               <div>
                    <input type="text" placeholder="Enter Option A" name= "option1"
                        class=" w-full px-4 py-2 border border-gray-300 rounded-xl focus:outline-none">
                </div>

               <div>
                    <input type="text" placeholder="Enter Option B" name= "option2"
                        class=" w-full px-4 py-2 border border-gray-300 rounded-xl focus:outline-none">
                </div>

               <div>
                    <input type="text" placeholder="Enter Option C" name= "option3"
                        class=" w-full px-4 py-2 border border-gray-300 rounded-xl focus:outline-none">
                </div>

               <div>
                    <input type="text" placeholder="Enter Option D" name= "option4"
                        class=" w-full px-4 py-2 border border-gray-300 rounded-xl focus:outline-none">
                </div>
